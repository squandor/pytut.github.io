...
class{% endhighlight %} keyword and the name of the class:
{% highlight python %}
class Dog:{% endhighlight %}
{% highlight python %}
class House:
{% endhighlight %}
{% highlight python %}
class Ball:{% endhighlight %}
{% highlight python %}
class Poodle(Dog):{% endhighlight %}
{% highlight python %}
class Truck(Vehicle):{% endhighlight %}
{% highlight python %}
class Mom(FamilyMember):{% endhighlight %}
...
FamilyMember{% endhighlight %}
{% highlight python %}
__init__{% endhighlight %} and instance attributes
...
__init__{% endhighlight %}. This is a method that runs when we create an instance of the class. 
...
Dog{% endhighlight %} class with this method:
{% highlight python %}
class Dog:
...
Dog{% endhighlight %}, we need to specify the name and age of the dog instance to assign these values to the attributes:
{% highlight python %}
my_dog = Dog("Nora", 10){% endhighlight %}
...
<attribute>=<value>{% endhighlight %} in the list of parameters. 
This is an example:
{% highlight python %}
class Circle:
...
Circle{% endhighlight %} instance with the default value for the radius by omitting the value or customize it by passing a value:
{% highlight python %}
# Default value
>>> my_circle1 = Circle()
...
{% highlight python %}
<object_variable>.<attribute>{% endhighlight %}
For example:
{% highlight python %}
# Class definition
>>> class Dog:
...
{% highlight python %}
<object_variable>.<attribute> = <new_value>{% endhighlight %}
For example:
{% highlight python %}
>>> class Dog:
...
{% highlight python %}
del <object_variable>.<attribute>{% endhighlight %}
For example:
{% highlight python %}
>>> class Dog:
...
{% highlight python %}
<class_name>.<attribute>{% endhighlight %}
For example:
{% highlight python %}
>>> class Dog:
...
{% highlight python %}
<class_name>.<attribute> = <value>{% endhighlight %}
For example:
{% highlight python %}
>>> class Dog:
...
del{% endhighlight %} to delete a class attribute. For example:
{% highlight python %}
>>> class Dog:
...
self{% endhighlight %} as the first parameter.
For example, here is a {% highlight python %}
bark{% endhighlight %} method with no parameters (in addition to {% highlight python %}
self{% endhighlight %}):
{% highlight python %}
class Dog:
...
{% highlight python %}
<object_variable>.<method>(<arguments>){% endhighlight %}
For example:
{% highlight python %}
# Create the instance
>>> my_dog = Dog("Nora", 10)
...
Player{% endhighlight %} class with an {% highlight python %}
increment_speed{% endhighlight %} method with one parameter:
{% highlight python %}
class Player:
